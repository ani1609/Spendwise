...
function Transactions({
  ...
  useEffect(() => {
    if (user && user.email) {
      ...
      console.log("the transactions are", q);
      ...
      return onSnapshot(q, (snapshot) => {
        ...
        const transactiontype = localStorage.getItem("transactionType")
          ...
          : "";
        const datefiter = localStorage.getItem("dateFilter")
      ...
      <div className="transaction-group row flex flex-col">
        ...
        <div className="flex justify-between mt-3">
          <div className="form-group col-md-4">
            <div
              className="custom-dropdown transition-colors"
          ...
          <div>
            <div className="form-group col-md-4">
              <div
                className="custom-dropdowntransition-colors"
              ...
              >
                ...
                <div className="descDate_container">
                  {transaction.description.length > descriptionChars ? (
                    <h4>
                      {transaction.description.substring(0, descriptionChars) +
                        "..."}
                    </h4>
                  ) : (
                ...
                <div className="editDelete_container">
                  <Edit
                    className="edit_icon"
                    onClick={() => handleEdit(transaction.transactionId, index)}
                  />
                  <Delete
              ...
              >
                <div className="icon_container transition-colors bg-primary-light dark:bg-primary-dark">
                  ...
                  {transaction.category === "Travel" ? (
                    <Travel className="icons transition-colors fill-white" />
                  ) : null}
                  {transaction.category === "Shopping" ? (
                    <Shopping className="icons transition-colors fill-white" />
                  ) : null}
                  {transaction.category === "Bills" ? (
                    <Bills className="icons transition-colors fill-white" />
                  ) : null}
                  {transaction.category === "Others" ? (
                    <Others className="icons transition-colors fill-white" />
                  ) : null}
                </div>
                <div className="descDate_container">
                  {transaction.description.length > descriptionChars ? (
