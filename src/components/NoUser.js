  ...
  return (
    <div className="noUser_container">
      ...
      <button
        ...
        className="bg-black border-2 transition-colors text-white rounded-lg p-2 px-8 md:px-40 hover:bg-white hover:text-black ease-in-out text-sm md:text-base lg:text-lg max-w-full"
      >
        Get Started
      </button>
    </div>
