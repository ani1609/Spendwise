...
function Home({
  ...
  return (
    <div>
      <div className="bg-violet transition-colors dark:bg-[#132b39] text-white flex justify-center"></div>
      {
        <svg
        ...
        >
          <path
            ...
            fill={theme === "dark" ? "rgba(19,43,57,1)" : "#b6cefc"}
            ...
            <Route
              ...
              element={
                <Home
                  ...
                  userFirebaseRefId={userFirebaseRefId}
                  showSignupForm={showSignupForm}
                  setShowSignupForm={setShowSignupForm}
                />
              }
