  ...
  return (
    <div className="signup_form_container" onClick={(e) => e.stopPropagation()}>
      ...
      <form onSubmit={handleSignup}>
        ...
        {invalidEmailFOrmat && (
          <p className="error_message">Invalid email format</p>
        )}
        {invalidName && <p className="error_message">Invalid name format</p>}
        {invalidPassword && (
          <p className="error_message">Invalid Password format</p>
        )}
        {emailVerificationSent && (
          <p className="error_message" style={{ color: "white" }}>
            Email verification sent. Please verify.
          </p>
        )}
        <button
          type="submit"
        ...
        <div
          className="signupSeparator flex justify-center items-center"
          style={{ width: "100%" }}
        >
      ...
      <button
        className="googleSignup p-2 border flex justify-center gap-2 hover:border-slate-400 dark:hover:border-slate-500 hover:text-slate-900 dark:hover:text-slate-300 hover:shadow transition duration-150"
