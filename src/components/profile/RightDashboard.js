  ...
  return (
    <>
      <div className="relative sm:left-60 -left-0 -z-10 sm:w-[calc(100%-240px)] w-[100%]">
        {/* Profile Heading */}
        <div className="profile-heading-container sm:w-[calc(100%-240px)] w-[100%] flex sm:justify-start justify-center">
          <h1 className="font-[Inter] text-[#024164] text-[19px] font-semibold pl-2 transition-colors dark:text-[#97cbe7]">
            Profile
          </h1>
        </div>
        ...
        <div className="profile-container w-[90%] ml-[5%] flex gap-5 justify-center flex-wrap absolute top-32">
          <div className="profile-picture border border-slate-950/20 rounded-[5px] bg-white transition-colors dark:bg-[#011019] w-max px-10 py-7">
            <div>
              <img
            ...
            <div>
              <p className="font-[Inter] text-[#024164] transition-colors dark:text-[#97cbe7] font-bold text-[17px] text-center mt-4">
                Your Name
              </p>
            </div>
          </div>
          ...
          {/* Profile Settings */}
          <div className="profile-settings border border-slate-950/20 rounded-[5px] bg-white w-full md:w-[31rem] transition-colors dark:bg-[#011019]">
            <h2 className="font-[Inter] font-semibold text-[19px] text-[#024164] transition-colors dark:text-[#B6CEFC] bg-[#EAF0FB] dark:bg-[#335467] border border-slate-950/20 px-2 py-4">
              Account Settings
            </h2>
            <form className="p-4">
              <div className="mb-2">
                <label
                  htmlFor="first-name"
                  className="block font-[Inter] text-[19px] text-[#514949] transition-colors dark:text-[#B6CEFC]"
                >
                  First Name
                </label>
                <input
                  type="text"
                  id="first-name"
                  className="bg-[#f2f2f2] dark:bg-[#335467] border border-slate-900/20 w-full md:w-[29rem] h-[2.8rem] text-[#555] transition-colors dark:text-[#B6CEFC] text-xl px-2"
              ...
              <div>
                ...
                <input
                  type="text"
                  id="last-name"
                  className="bg-[#f2f2f2] transition-colors dark:bg-[#335467] dark:text-[#B6CEFC] border border-slate-900/20 w-full md:w-[29rem] h-[2.8rem] text-[#555] text-xl px-2"
