      ...
      <div className="flex gap-x-4 max-sm:gap-x-2 justify-center items-center">
        {userFirebaseRefId && (
          ...
          >
            <svg
              ...
              className="w-8 h-8 max-md:w-7 max-md:h-7 max-sm:w-6 max-sm:h-6 max-[400px]:w-5 max-[400px]:h-5"
            >
        ...
        {userFirebaseRefId && (
          <div className="p-2 max-sm:p-1 cursor-pointer" onClick={handleLogOut}>
            <LogOut className="w-8 h-8 max-md:w-7 max-md:h-7 max-sm:w-6 max-sm:h-6 max-[400px]:w-5 max-[400px]:h-5" />
          </div>
        )}
        {userFirebaseRefId ? (
