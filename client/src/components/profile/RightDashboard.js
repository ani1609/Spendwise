  ...
  return (
    <>
      <div className='relative sm:left-60 -left-0 -z-10 sm:w-[calc(100%-240px)] w-[100%]' >
        ...
        >
          <h1 className='font-[Inter] text-[#024164] dark:text-[#97cbe7] text-[19px] font-semibold pl-2'>
            Profile
          </h1>
        </div>
        ...
        <div className='profile-container w-[90%] ml-[5%] flex gap-5 justify-center flex-wrap absolute top-32'>
          ...
          {/* Profile Settings */}
          <div className='profile-settings border border-slate-950/20 rounded-[5px] bg-white dark:bg-[#011019] w-full md:w-[31rem]'>
