  ...
  return (
    ...
    {/* Profile Heading */}
      <div className='profile-heading-container'>
        <h1 className='w-[90%] mx-auto font-[Inter] text-[#024164] text-[19px] font-semibold'>
          Profile
        </h1>
      </div>
    {/* Background Containing Triangles on two rows */}
      <div className='relative'>
        <div className='triangle-row-container bg-[#B6CEFC] relative'>
          <div id='triangle-row' className='traingle-row w-[90%] mx-auto flex flex-wrap'>
      ...
      <div className='profile-container flex w-[90%] mx-auto gap-5 justify-center flex-wrap absolute left-[5%] top-32'>
